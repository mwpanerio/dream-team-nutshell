 ...
 * Change Yoast's default breadcrumb wrapper
 *
 * @param   string  $wrapper    Default wrapper element
 * @return  string              Filtered wrapper
 */
add_filter( 'wpseo_breadcrumb_output_wrapper', 'fx_yoast_change_breadcrumb_output_wrapper' );
